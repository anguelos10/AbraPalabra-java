...
public class Fragment_Agenda extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup viewGroup, Bundle savedInstanceState){
        rootView = inflater.inflate(R.layout.fragment_agenda, viewGroup, false);
        ...
        database.getReference().child(family).child(idFamily).child(idKid).orderByChild("tipo").equalTo("8").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
