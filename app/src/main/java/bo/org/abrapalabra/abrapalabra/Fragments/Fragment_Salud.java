...
public class Fragment_Salud extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup viewGroup, Bundle savedInstanceState){
        rootView = inflater.inflate(R.layout.fragment_salud, viewGroup, false);
        ...
        database.getReference().child(family).child(idFamily).child(idKid).orderByChild("tipo").equalTo("5").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
