...
public class Fragment_academico extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup viewGroup, Bundle savedInstanceState){
        rootView = inflater.inflate(R.layout.fragment_academico, viewGroup, false);
        ...
        database.getReference().child(family).child(idFamily).child(idKid).orderByChild("tipo").equalTo("6").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
